...
static void _SetThreadPriority(pthread_t threadHandle, ThreadPriority prio)
{
    ...
    switch (prio) {
    case ThreadPriority::Normal:    policy = policy; param.sched_priority = prioNormal; break;
    ...
    case ThreadPriority::High:      policy = policy; param.sched_priority = prioNormal + (prioMax - prioNormal)/2; break;
    case ThreadPriority::Low:       policy = policy; param.sched_priority = prioMin; break;
    }
