...
static_assert(GfxImageUsageFlags::TransferSrc == GfxImageUsageFlags(VK_IMAGE_USAGE_TRANSFER_SRC_BIT));
static_assert(GfxImageUsageFlags::TransferDst == GfxImageUsageFlags(VK_IMAGE_USAGE_TRANSFER_DST_BIT));
static_assert(GfxImageUsageFlags::Sampled == GfxImageUsageFlags(VK_IMAGE_USAGE_SAMPLED_BIT));
static_assert(GfxImageUsageFlags::Storage == GfxImageUsageFlags(VK_IMAGE_USAGE_STORAGE_BIT));
static_assert(GfxImageUsageFlags::ColorAttachment == GfxImageUsageFlags(VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT));
static_assert(GfxImageUsageFlags::DepthStencilAttachment == GfxImageUsageFlags(VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT));
static_assert(GfxImageUsageFlags::TransientAttachment == GfxImageUsageFlags(VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT));
static_assert(GfxImageUsageFlags::InputAttachment == GfxImageUsageFlags(VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT));

static_assert(GfxBufferUsageFlags::TransferSrc == GfxBufferUsageFlags(VK_BUFFER_USAGE_TRANSFER_SRC_BIT));
static_assert(GfxBufferUsageFlags::TransferDst == GfxBufferUsageFlags(VK_BUFFER_USAGE_TRANSFER_DST_BIT));
static_assert(GfxBufferUsageFlags::UniformTexel == GfxBufferUsageFlags(VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::StorageTexel == GfxBufferUsageFlags(VK_BUFFER_USAGE_STORAGE_TEXEL_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::Uniform == GfxBufferUsageFlags(VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::Storage == GfxBufferUsageFlags(VK_BUFFER_USAGE_STORAGE_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::Index == GfxBufferUsageFlags(VK_BUFFER_USAGE_INDEX_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::Vertex == GfxBufferUsageFlags(VK_BUFFER_USAGE_VERTEX_BUFFER_BIT));
static_assert(GfxBufferUsageFlags::Indirect == GfxBufferUsageFlags(VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT));
