...
if "%CONFIG%"=="releasedev" (
    ...
    set DEFINES=%DEFINES% -D_ITERATOR_DEBUG_LEVEL=0 -DTRACY_ENABLE -DCONFIG_ENABLE_ASSERT 
    set LIBS=%LIBS% "dbghelp.lib" "Advapi32.lib"
    set LINK_FLAGS=%LINK_FLAGS% /DEBUG:FULL
    set CONFIG_KNOWN=1
)
...
if "%CONFIG%"=="releaseasan" (
    ...
    set DEFINES=%DEFINES% -D_ITERATOR_DEBUG_LEVEL=0 -DCONFIG_ENABLE_ASSERT
    set LIBS=%LIBS% "dbghelp.lib" "Advapi32.lib"
    set LINK_FLAGS=%LINK_FLAGS% /DEBUG:FULL
    set CONFIG_KNOWN=1
)
